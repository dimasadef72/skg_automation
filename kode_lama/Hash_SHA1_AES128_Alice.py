...
with open(r"C:/Users/NADA VIDYAN SASMITA/OneDrive/Documents/semester 7/TA/skg/Output/P2P/hasilBCH_eve/Alice_BCH.csv", newline='') as f:
    reader = csv.reader(f)
...
with open(r"C:/Users/NADA VIDYAN SASMITA/OneDrive/Documents/semester 7/TA/skg/Output/P2P/hasilHASH_eve/ALICE_HASH.csv", "w", newline="") as fp:
    writer = csv.writer(fp)
    writer.writerow(["Alice"])
    for val in univ1:
        writer.writerow(val)

print("Universal Hash Alice disimpan ke files/ALICE_HASH.csv")
...
with open(r"C:/Users/NADA VIDYAN SASMITA/OneDrive/Documents/semester 7/TA/skg/Output/P2P/hasilNIST_eve/ALICE_NIST.csv", newline='') as f:
    reader = csv.reader(f)
    for row in reader:
        indeks.append(row)
...
csv_filename = 'C:/Users/NADA VIDYAN SASMITA/OneDrive/Documents/semester 7/TA/skg/Output/P2P/hasilSHA_eve/ALICE_SHA128.csv'
...
for kuncinya in range(min(len(indek), len(hex1))):
    if hex1[kuncinya] == hex2[kuncinya]:
        ...
        print(f'Key Alice 1 (16 bytes) = {keybyte}')
        key_found = True
        break
...
if not key_found:
    ...
    output_file = os.path.join(output_dir, "ALICE_AES.txt")
